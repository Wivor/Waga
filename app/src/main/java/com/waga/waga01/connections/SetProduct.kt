...
class SetProduct(val context: Context, val login: String, val pass: String, val cont : Container, val product : Product) : AsyncTask<String, String, String>() {
    ...
    override fun doInBackground(vararg params: String): String {
        ...
        try {
            ...
            if (stmtProd.execute("call edit_container(" + cont.id + "," + product.id + ")")) {
                isSuccess = true
            }
