...
class EditProduct(val context: Context, val login: String, val pass: String, val product : Product) : AsyncTask<String, String, String>() {
    ...
    override fun onPreExecute() {
        println("edit_product(" + product.id + ", '" + product.name + "', null, null, null)")
 //       this.callBack.UpdateMyText("Loading...")
    ...
    override fun doInBackground(vararg params: String): String {
        ...
        try {
            ...
            productset = stmtProd!!.executeQuery("call edit_product(" + product.id + ", '" + product.name + "', null, null, null)")

            if (stmtProd.execute("call edit_product(" + product.id + ", '" + product.name + "', null, null, null)")) {
