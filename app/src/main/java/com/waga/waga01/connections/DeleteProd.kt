...
class DeleteProd(val context: Context, val login: String, val pass: String, val product : Product) : AsyncTask<String, String, String>() {
    ...
    override fun doInBackground(vararg params: String): String {
        ...
        try {
            ...
            if (stmtProd.execute("call delete_product(" + product.id + ")")) {
                isSuccess = true
            }
